...
# Train the model
model.fit(X_train, y_train, epochs=4000, batch_size=len(X_train))
...
print('Testing R2 for Bayesian Regression is:', r2_score(y_test, mean_predictions))
...
print('Testing R2 for Regular Regression is:', r2_score(y_test, y_test_pred))
